      ...
      <section className="border-b border-border/60">
        <div className="mx-auto flex w-full max-w-[1180px] items-center justify-between px-5 py-5 sm:px-8">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            <Link
              className="hidden rounded-md px-3 py-2 text-sm text-muted-foreground transition hover:bg-white/70 hover:text-foreground sm:inline-flex"
              href="/suporte"
            >
              Suporte
            </Link>
            <Link
              className="hidden rounded-md px-3 py-2 text-sm text-muted-foreground transition hover:bg-white/70 hover:text-foreground md:inline-flex"
              href="/termos-de-uso"
            >
              Termos
            </Link>
      ...
      <footer className="border-t border-border/60 bg-white/80">
        <div className="mx-auto flex w-full max-w-[1180px] flex-wrap items-center justify-between gap-4 px-5 py-7 text-sm text-muted-foreground sm:px-8">
          ...
          <nav className="flex flex-wrap gap-3">
            ...
            <Link className="hover:text-foreground" href="/politica-de-cookies">
              Cookies
            </Link>
            <Link className="hover:text-foreground" href="/acordo-de-tratamento-de-dados">
              Acordo LGPD
            </Link>
            <Link className="hover:text-foreground" href="/suporte">
              Suporte
            </Link>
          </nav>
        </div>
